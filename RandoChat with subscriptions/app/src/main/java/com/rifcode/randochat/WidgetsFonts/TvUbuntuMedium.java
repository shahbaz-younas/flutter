...
public class TvUbuntuMedium extends androidx.appcompat.widget.AppCompatTextView  {


    AttributeSet attr;

    public TvUbuntuMedium(Context context) {
        super(context);
        setCustomFont(context, attr);
    }

    public TvUbuntuMedium(Context context, AttributeSet attrs) {
        super(context, attrs);
        setCustomFont(context, attrs);
    }

    public TvUbuntuMedium(Context context, AttributeSet attrs, int defStyle) {
