...
public class TvUbuntuBold extends androidx.appcompat.widget.AppCompatTextView  {


    AttributeSet attr;

    public TvUbuntuBold(Context context) {
        super(context);
        setCustomFont(context, attr);
    }

    public TvUbuntuBold(Context context, AttributeSet attrs) {
        super(context, attrs);
        setCustomFont(context, attrs);
    }

    public TvUbuntuBold(Context context, AttributeSet attrs, int defStyle) {
