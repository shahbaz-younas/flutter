...
public class TvUbuntuRegular extends androidx.appcompat.widget.AppCompatTextView  {


    AttributeSet attr;

    public TvUbuntuRegular(Context context) {
        super(context);
        setCustomFont(context, attr);
    }

    public TvUbuntuRegular(Context context, AttributeSet attrs) {
        super(context, attrs);
        setCustomFont(context, attrs);
    }

    public TvUbuntuRegular(Context context, AttributeSet attrs, int defStyle) {
