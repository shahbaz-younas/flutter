...
import com.qearner.quiz.helper.Security;
     ...
     for (Purchase purchase : purchases) {
            ...
            if (purchase.getSkus().contains(PRODUCT_ID) && purchase.getPurchaseState() == Purchase.PurchaseState.PURCHASED) {
                if (!verifyValidSignature(purchase.getOriginalJson(), purchase.getSignature())) {
                    ...
                    Utils.UpdateCoin(CoinStoreActivity.this, "+" + coins);
                    Utils.AddCoins(CoinStoreActivity.this,coins,"In-App Purchase","Buy Coins","0");
                }
