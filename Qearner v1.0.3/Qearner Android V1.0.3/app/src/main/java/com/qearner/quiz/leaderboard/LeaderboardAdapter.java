...
public class LeaderboardAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder holder1, final int position) {
        ...
        if (holder1 instanceof ItemRowHolder) {
            ...
            holder.imgRank1.setDefaultImageResId(R.drawable.ic_launcher);
            holder.imgRank2.setDefaultImageResId(R.drawable.ic_launcher);
            holder.imgRank3.setDefaultImageResId(R.drawable.ic_launcher);
    ...
    public class TopHolder extends RecyclerView.ViewHolder {
        public TextView tvRank1, tvRank2, tvRank3, tvScore1, tvScore2, tvScore3;
        public CircleImageView imgRank1, imgRank2, imgRank3;
        public LinearLayout lytRank1, lytRank2, lytRank3;
